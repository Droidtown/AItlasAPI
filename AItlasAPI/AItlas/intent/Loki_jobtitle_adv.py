...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "美國前總統拜登":
        if CHATBOT:
            ...
            resultDICT[INTENT_NAME.split("_")[0]].append({args[6]:args[3]})
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("美國前總統拜登", "美國前總統拜登", [], {}, {})
    pprint(resultDICT)