...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "王小明的哥哥王大明":
        if CHATBOT:
            ...
            resultDICT[INTENT_NAME.split("_")[0]].append({args[0]:args[2]})
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("王小明的哥哥王大明", "王小明的哥哥王大明", [], {}, {})
    pprint(resultDICT)