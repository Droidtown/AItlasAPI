...
"""
    Loki module for nationality_adv
...
MODULE_DICT = {
    "Account": import_from_path("AItlas_lib_Account", os.path.join(os.path.dirname(CWD_PATH), "lib/Account.py"))
}
"""
Account 變數清單
[變數] BASE_PATH         => 根目錄位置
...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "美國總統拜登":
        if CHATBOT:
            ...
            if args[0] in aitlas_get_country(args[0], "get_country"):
                resultDICT[INTENT_NAME.split("_")[0]].append({args[6]:args[0]})
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("美國總統拜登", "美國總統拜登", [], {}, {})
    pprint(resultDICT)