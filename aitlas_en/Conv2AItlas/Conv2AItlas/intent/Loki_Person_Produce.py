...
"""
    Loki module for Person_Produce
...
def debugInfo(inputSTR, utterance):
    if DEBUG_Person_Produce:
        print("[Person_Produce] {} ===> {}".format(inputSTR, utterance))

def getResult(inputSTR, utterance, args, resultDICT):
    debugInfo(inputSTR, utterance)
    if utterance == "[Shakespeare] produce [most] [of] [his] [known] work [between] [1589] and [1613]":
