...
"""
    Loki module for Person_Develop
...
def debugInfo(inputSTR, utterance):
    if DEBUG_Person_Develop:
        print("[Person_Develop] {} ===> {}".format(inputSTR, utterance))

def getResult(inputSTR, utterance, args, resultDICT):
    debugInfo(inputSTR, utterance)
    if utterance == "[He] develop [his] " nuclear mysticism " style":
        # write your code here
        pass

    if utterance == "[He] develop [networks] [of] [roads] [with] an [official] [courier] [system]":
        # write your code here
        pass
