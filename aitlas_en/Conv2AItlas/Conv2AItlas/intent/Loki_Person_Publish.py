...
"""
    Loki module for Person_Publish
...
def debugInfo(inputSTR, utterance):
    if DEBUG_Person_Publish:
        print("[Person_Publish] {} ===> {}".format(inputSTR, utterance))

def getResult(inputSTR, utterance, args, resultDICT):
    debugInfo(inputSTR, utterance)
    if utterance == "[Obama] have publish [three] [best-selling] [books]":
